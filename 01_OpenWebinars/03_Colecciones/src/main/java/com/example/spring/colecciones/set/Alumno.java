...
public class Alumno {
	...
	public String toString() {
		...
		// StringBuffer es un método mucho más conveniente para trabajar con cadenas
		// dinámicas
		StringBuffer sb = new StringBuffer();
		// Concatenamos el inicio de la cadena
		sb.append("Alumno [nombre=" + nombre + ", notas=[");
		/*
		 * Para todas las notas, a excepción de la última, añadimos su reperesentación
		 * como cadena de caracteres, y una coma. Transformamos el Set en un List para
		 * recorrerlo más cómodamente.
		 */
		...
		/*
		 * Añadimos la reperesentación como cadena de caracteres de la última nota, y
		 * corchete de cierre
		 */
